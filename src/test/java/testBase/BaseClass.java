...
public class BaseClass {
	...
	public void setUp(String os,String br) throws IOException
	{
       ...
       // to execute testcase using seleniumgrid(remote)
       if(p.getProperty("execution_env").equalsIgnoreCase("remote"))
       {
    	   ...
    	   driver = new RemoteWebDriver(new URL("http://192.168.31.118:4444/wd/hub"),capabilities);
       }
       // to execute the test case locally
